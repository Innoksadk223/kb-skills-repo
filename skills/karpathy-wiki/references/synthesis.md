...
2. **Gather relevant pages** — search `index.md` and use your file-search tool for concepts, entities, comparisons, existing claims, and any observation/structure/prediction nodes present.
